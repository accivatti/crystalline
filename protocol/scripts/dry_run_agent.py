#!/usr/bin/env python3
# [INPUT]: reads consumer repo's mounted agent, base role, overlay, workflow,
#          and run-state ledger.
# [OUTPUT]: dry-run warm-up CLI; prints structured readback skeleton with proactive
#           learning verdict — no external calls, no provider writes.
# [POS]: scripts runtime-readiness validator; verifies any runtime can boot the
#        agent contract and understands playbook/readback/proactive GEB routing.
